...
plot_sql_mapsize("../SQLRight_TLP/plot_data_0", markevery = 30, line_style = 0)
plot_sql_mapsize("./Squirrel_TLP/plot_data_0", markevery = 30, line_style = 1)
plot_sql_mapsize("./SQLancer_TLP/plot_data_0", markevery = 30, line_style = 2)
