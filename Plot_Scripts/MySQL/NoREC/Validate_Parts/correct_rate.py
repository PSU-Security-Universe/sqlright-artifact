...
plot_sql_correct_rate("../SQLRight_MySQL_NoREC/plot_data_0", markevery = 10, line_style = 4)
...
plot_sql_correct_rate("../SQLRight_MySQL_NoREC/plot_data_1", markevery = 10, line_style = 0)
