...
plot_sql_corr_over_time("../SQLRight_MySQL_TLP/plot_data_2", markevery = 10, line_style = 4)
plot_sql_corr_over_time("../SQLRight_MySQL_TLP/plot_data_0", markevery = 10, line_style = 0)
plot_sql_corr_over_time("./SQLRight_with_squ_valid/plot_data_1", markevery = 10, line_style = 2)
