...
plot_sql_corr_over_time("../SQLRight_TLP/plot_data_2", markevery = 30, line_style = 0)
plot_sql_corr_over_time("./Squirrel_TLP/plot_data_0", markevery = 30, line_style = 1)
plot_sqlancer_corr_over_time("./SQLancer_TLP/SQLancer_TLP_0/logs_35", markevery = 30, line_style = 2)
