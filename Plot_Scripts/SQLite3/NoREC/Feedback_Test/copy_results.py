...
drop_all_res_dir = os.path.join(sqlite_results_dir, "sqlright_sqlite_drop_all_NOREC")
random_save_res_dir = os.path.join(sqlite_results_dir, "sqlright_sqlite_random_save_NOREC")
save_all_res_dir = os.path.join(sqlite_results_dir, "sqlright_sqlite_save_all_NOREC")
