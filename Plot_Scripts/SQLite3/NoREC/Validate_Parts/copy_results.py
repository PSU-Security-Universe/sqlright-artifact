...
non_deter_res_dir = os.path.join(sqlite_results_dir, "sqlright_sqlite_NOREC_non_deter")
...
copy_sqlright_contents_in_dir(non_deter_res_dir, os.path.join(os.getcwd(), "./non_deter"))
