...
# Squirrel + oracle + Co_Mute + Per-DBMS-Parser
x = [0, 24]
y = [0, 0]
...
# Squirrel + oracle + Cooperative Mutation
x = [0, 23, 23, 45]
y = [0, 0, 1, 1]

x, y = sample_bug_num(x, y)

plot_with_style(x, y, style_id = 3, markevery = 30)
...
plot_with_style(x, y, style_id = 4, markevery = 30)
