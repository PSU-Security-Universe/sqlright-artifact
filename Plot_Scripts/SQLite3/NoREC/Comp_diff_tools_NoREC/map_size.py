...
plot_sql_mapsize("../SQLRight_NoREC/plot_data_0", markevery = 30, line_style = 0)
plot_sql_mapsize("./Squirrel_with_oracle/plot_data_0", markevery = 30, line_style = 1)
plot_sql_mapsize("./SQLancer/SQLancer_3/plot_data_30", markevery = 30, line_style = 2)
