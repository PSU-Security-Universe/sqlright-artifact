...
""" 
java -jar sqlancer-1.1.0.jar --num-queries 100000 --num-tries 100000  --log-execution-time false  --num-threads 5  postgres --oracle NoREC
"""
...
sqlancer_output_dir = "/home/luy70/Desktop/SQLRight_DBMS/sqlancer/sqlancer/target/logs/postgres/"

current_workdir = os.getcwd()

starting_core_id = 1
parallel_num = 1
port_starting_num = 5450
...
for cur_inst_id in range(starting_core_id, starting_core_id + parallel_num, 1):
    ...
    cur_postgre_data_dir_str = os.path.join(postgres_root_dir, "data_all/data_" + str(cur_inst_id))
